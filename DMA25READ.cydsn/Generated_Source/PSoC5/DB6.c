...
*
* \funcusage
*  \snippet DB6_SUT.c usage_DB6_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet DB6_SUT.c usage_DB6_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet DB6_SUT.c usage_DB6_Read  
*******************************************************************************/
uint8 DB6_Read(void)
{
...
* preferred DB6_Read() API because the 
* DB6_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet DB6_SUT.c usage_DB6_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: DB6_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use DB6_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - DB6_0_INTR       (First pin in the list)
    *  - DB6_1_INTR       (Second pin in the list)
    *  - ...
    *  - DB6_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet DB6_SUT.c usage_DB6_SetInterruptMode
    *******************************************************************************/
    void DB6_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & DB6_0_INTR) != 0u) 
		{ 
			 DB6_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet DB6_SUT.c usage_DB6_ClearInterrupt
    *******************************************************************************/
