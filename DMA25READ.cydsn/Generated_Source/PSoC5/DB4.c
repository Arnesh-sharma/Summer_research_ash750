...
*
* \funcusage
*  \snippet DB4_SUT.c usage_DB4_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet DB4_SUT.c usage_DB4_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet DB4_SUT.c usage_DB4_Read  
*******************************************************************************/
uint8 DB4_Read(void)
{
...
* preferred DB4_Read() API because the 
* DB4_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet DB4_SUT.c usage_DB4_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: DB4_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use DB4_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - DB4_0_INTR       (First pin in the list)
    *  - DB4_1_INTR       (Second pin in the list)
    *  - ...
    *  - DB4_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet DB4_SUT.c usage_DB4_SetInterruptMode
    *******************************************************************************/
    void DB4_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & DB4_0_INTR) != 0u) 
		{ 
			 DB4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet DB4_SUT.c usage_DB4_ClearInterrupt
    *******************************************************************************/
