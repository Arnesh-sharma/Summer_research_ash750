...
#define BS_UDB_1_4_0_CONFIG_VAL ((const uint8 CYFAR *)0x480009E4u)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000A64u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000A94u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x0081u);
